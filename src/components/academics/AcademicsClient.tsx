...
export default function AcademicsClient() {
  ...
  const streams = [
    {
      ...
      badge: 'PCM / PCB / PCMB',
      desc: data.scienceStreamDesc || 'Designed for aspiring engineers, doctors, researchers, architects, and technologists.',
      subjects: [
        'Physics',
        'Chemistry',
        'Mathematics / Biology',
    ...
    },
    {
      ...
      desc: data.commerceStreamDesc || 'Geared towards future entrepreneurs, chartered accountants, economists, and corporate leaders.',
      subjects: [
        'Accountancy',
        'Business Studies',
        'Economics',
  ...
  return (
    <>
      <PageHeader
        eyebrow={data.academicsHeroEyebrow || 'Academic Excellence'}
        title={data.academicsHeroTitle || 'Curriculum & Pedagogy'}
        subtitle={data.academicsHeroSubtitle || 'Empowering learners through structured CBSE syllabus, scientific inquiry, and experiential learning'}
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <p className="text-amber-600 font-bold text-xs uppercase tracking-[0.2em]">
                {data.academicsPhilosophyEyebrow || 'Our Philosophy'}
              </p>
              <span className="w-6 h-px bg-amber-500" />
            </div>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-navy-950 mb-6 leading-tight">
              {data.academicsPhilosophyTitle || 'A Child-Centric, Concept-Driven Educational Framework'}
            </h2>
            <p className="text-slate-600 leading-relaxed mb-4">
              {data.academicsPhilosophyP1 || (
                <>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              {data.academicsPhilosophyP2 || 'Our classroom pedagogy places the child at the center of the learning process, blending interactive digital simulations, lab practicals, group debates, and self-directed inquiries.'}
            </p>
