  ...
  const steps = [
    {
      ...
      desc: 'Submit the online enquiry form on this page or collect the registration form from the school admission desk.',
    },
    {
      num: '02',
      title: 'Document Verification',
      desc: 'Submit copies of birth certificate, residential proof, previous report cards, and photographs for preliminary verification.',
    },
    {
      num: '03',
      title: 'Student & Parent Interaction',
      desc: 'An informal interaction for Pre-Primary applicants or a written proficiency assessment for Classes I to XI.',
    },
    {
      num: '04',
      title: 'Fee Payment & Enrolment',
      desc: 'Upon confirmation of admission offer, pay the admission fee and collect the student kit, ID card, and academic calendar.',
    },
  ];
  ...
  return (
    <>
      <PageHeader
        ...
        title="Admission Guidelines & Enquiry"
        subtitle="Begin your child's journey towards academic excellence and holistic personality development"
            ...
            <div className="lg:col-span-6 space-y-10">
              ...
              <div>
                ...
                <h2 className="font-serif text-3xl sm:text-4xl font-bold text-navy-950 mb-4 leading-tight">
                  Join the Decent Public School Family
                </h2>
                ...
                <div className="p-5 rounded-2xl bg-amber-50 border border-amber-200">
                  ...
                  <p className="text-xs text-slate-600 mt-1">
                    Direct Hotline: <strong>{school.phone_admissions}</strong> / <strong>{school.phone_office}</strong>
                  </p>
                </div>
              </div>
