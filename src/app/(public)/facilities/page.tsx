  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Modern amenities, safety protocols, and advanced academic technology designed for student excellence"
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          <SectionHeader
            ...
            subtitle="Explore how our campus facilities provide an enriching backdrop for every child's development"
          />
